...
while (repeat):
    ...
    #Initially all squares in array as empty
    #This array keeps track of where ships are and if user correctly hit
    ...
    for i in range(100):
            lists.append(i)
    #first we will append e(empty) spots in the list 
    elements =[]
    for i in range(100):
            elements.append("e")
    while(True):   
        C = random.choice(lists)#carrier
        direct = [1, 2, 3, 4]
    ...
    while(True):   
        B = random.choice(lists)#battleship
        direct = [1, 2, 3, 4]
        arrangement = random.choice(direct)
    ...
    while(True):   
        S = random.choice(lists)#submarine
        direct = [1, 2, 3, 4]
        arrangement = random.choice(direct)
    ...
    while(True):   
        D = random.choice(lists)#destroyer
        direct = [1, 2, 3, 4]
        arrangement = random.choice(direct)
    ...
    quit = True
    while (quit):
            #if player hits P(Play). The game will start
            if (BeginInput == "P" or BeginInput == "Play" or BeginInput == "p" or BeginInput == "play"):
                        ...
                        if (Points == 17):
                            ...
                            if chooseRow in mydict and chooseColumn < 11:
                                ...
                                if locationArray[rowNumber][chooseColumn] in ships:
                                    print("It hit")
                                    Points +=1
                                    locationArray[rowNumber][chooseColumn] = "H" #append H (Hit) if hits.
                                    ...
                                    print("You missed it")
                                    locationArray[rowNumber][chooseColumn] = "M" #append M (Miss) if hits.
                                    x_coord = -180+(chooseColumn*40)
            ...
            #if player hits I(Instructions). The game will display Instructions
            elif (BeginInput == "I" or BeginInput == "Instructions" or BeginInput == "i" or BeginInput == "instructions"):
                print("The game of Battleship is a luck-based game! The objective is to sink all the ships of the computer which has"
                ...
                BeginInput = input("Welcome to the game of Battleship! Would you like to (P)lay, Read the (I)nstructions, or (Q)uit?: ")
                continue
             #if player hits Q(Quit). The game will stop
                ...
                BeginInput = input("Welcome to the game of Battleship! Would you like to (P)lay, Read the (I)nstructions, or (Q)uit?: ")
                continue
    #if points  is equal to 17, It will ask player to play again.
    if(Points==17 or quit==False):
